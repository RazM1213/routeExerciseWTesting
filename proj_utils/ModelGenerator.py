...
from tests.test_model.TestInputStudentDetails import TestInputStudentDetails
from tests.test_model.TestInputSubjectGrades import TestInputSubjectGrades
...
# input_test = ModelGenerator.generate_input_model()
# print(input_test.__dict__)
# print(json.dumps(input_test.__dict__))
